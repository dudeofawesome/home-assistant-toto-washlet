...
class TotoWashletCode(Enum):
    ...
    WATER_TEMPERATURE_1 = (TotoData(0xEC, 0x8, 0x1),)
    WATER_TEMPERATURE_2 = (TotoData(0xEC, 0xA, 0x1),)
    WATER_TEMPERATURE_3 = (TotoData(0xEC, 0x1, 0x1),)
    WATER_TEMPERATURE_4 = (TotoData(0xEC, 0x9, 0x1),)
    WATER_TEMPERATURE_5 = (TotoData(0xEC, 0xD, 0x1),)
    ...
    SEAT_TEMPERATURE_1 = (TotoData(0xEC, 0xA, 0x8),)
    SEAT_TEMPERATURE_2 = (TotoData(0xEC, 0xA, 0xA),)
    SEAT_TEMPERATURE_3 = (TotoData(0xEC, 0xA, 0x1),)
    SEAT_TEMPERATURE_4 = (TotoData(0xEC, 0xA, 0x9),)
    SEAT_TEMPERATURE_5 = (TotoData(0xEC, 0xA, 0xD),)
